...
engine.setProperty(
    "voice", voices[0].id
)  # thisis used to use the voices of the computer
...
def takecommand():
    ...
    with sr.Microphone() as source:
        ...
        audio = r.listen(
            source
        )  # to see everything about this please press control and click on the line
    try:
        print("Recognizing..........")
...
def stoplisting():
    speak("for how much seconed  you want to stop jarvise  from listening commands")
    try:
        a = int(takecommand())
    ...
    while 1:
        ...
        try:
            ...
            if "wikipedia" in queuery:
                ...
                speak("I have been created by Akhilesh.")
                ...
                # music_dir = "G:\\Song"
                speak(
                    "you open another programe would you like to sleep mor exit from the program"
                )
                ...
                speak(
                    f"sorry {sex} because of me you face some problem "
            ...
            elif "know vivekanand" in queuery:
                speak(
                ...
                speak(
                    "wow why did you not tell me before that hy babe how are you will you be my gf"
                )
                ...
                speak(f"jarvise 2 point 0 in your service {sex}")
            elif "open python" in queuery:
...
def dd():
    while True:
        try:
            ...
            s2 = takecommand().lower()
            if "yes" in s2:
                s3 = takecommand()
                app.UntitledNotepad.Edit.type_keys(
                    s3, pyautogui.hotkey("enter"), with_spaces=True
                )
